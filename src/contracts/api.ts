...
export interface GameSnapshotSummary {
  roomId: EntityId;
  roomCode: string;
  gameId: EntityId;
  ...
  stageEndsAt: IsoTimestamp | null;
  teamCount: number;
  assignedPlayerCount: number;
  activePlayerCount: number;
  solvedPlayerCount: number;
  activeLockPlayerId: EntityId | null;
  visibleHintCount: number;
}

export interface GetGameSnapshotResponse {
  snapshot: GameRuntimeSnapshot;
}

export interface ListGameSnapshotsResponse {
  games: GameSnapshotSummary[];
}
